...
import { getCurriculum, getKanji, getQuestionIndex, getVocabulary } from "@/lib/content";
...
import { levelForPhase, questionLevelsUpTo } from "@/components/study/helpers";
...
export default async function TestsPage() {
  ...
  // Ship a packed slim index of the levels the hub can draw from (full records are fetched on
  // demand; lesson links for wrong answers are resolved by QuizRunner on demand); when the current
  // day is unknown keep every level.
  ...
  return (
    <Container wide>
      <TestsHubClient questionIndex={questionIndex} contentLinks={{}} phases={phases} drillPool={drillPool} />
    </Container>
  );
}
