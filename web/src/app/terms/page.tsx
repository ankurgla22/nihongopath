  ...
  const sections: { id: string; title: string; body: string[] }[] = [
    ...
    },
    {
      ...
      body: [
        ...
        "The course is built on freely licensed Japanese language data. Word readings and meanings are taken from and checked against JMdict and KANJIDIC2, published by the Electronic Dictionary Research and Development Group and used under the Creative Commons Attribution-ShareAlike 4.0 licence (creativecommons.org/licenses/by-sa/4.0/). A minority of the example sentences derive from the Tatoeba corpus, used under the Creative Commons Attribution 2.0 France licence (creativecommons.org/licenses/by/2.0/fr/). Both remain the work of their contributors, and both have been adapted for this site: entries were selected, re-levelled, edited and in places rewritten. The lesson text, explanations and the remaining sentences are written for this site.",
